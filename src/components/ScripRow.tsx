...
const ScripRow:React.FC<ScripRowProps>=({
    ...
    return (
        <div className="flex items-center justify-between gap-4 py-3 text-black  max-w-80 w-full h-16 border border-gray-200 ">
            <div className="flex items-center gap-3 max-w-52 h-5">
            ...
            <div className="flex flex-col items-end gap-0.5 w-23 h-10 ">
